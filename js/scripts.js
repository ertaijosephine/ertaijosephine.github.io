$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Ertai and Josephine's Wedding",

            // Event start date
            start: new Date('Sept 02, 2023 11:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (true) {
            $.post('https://script.google.com/macros/s/AKfycbycQ8bOUBgpCnX3asg-LOAgxCqLxEsClwm2QaFaoCUz2_r6oS012JJuFJEGu4gZUIXU/exec', data)
                .done(function (data) {
                    console.log(data);
